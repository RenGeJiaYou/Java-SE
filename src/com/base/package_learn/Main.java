package com.base.package_learn;
// 研究包和作用域

import com.base.ploy.*;
import com.base.static_learn.Person;

public class Main {
    public static void main(String[] args) {
        // 调用不同包中的同名类，使用具体的包名+类名
        com.base.static_learn.Person p = new Person(1, 2, 3);

        com.base.entity.Person p2 = new com.base.entity.Person("a", 13, "male");
